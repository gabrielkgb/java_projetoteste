...
<body>
  <header>
    <nav class="nav-bar">
      ...
      <div class="nav-list">
        <ul>
          <li class="nav-item"><a href="home.html" class="nav-link" style="color: #03A0C6;">Início</a></li>
          <li class="nav-item"><a href="servicos.html" class="nav-link" style="color: #03A0C6;">Servi�os</a>
          </li>
        ...
        <div class="login-form">
          ...
          <form action="LoginServlet" method="post">
            <div class="input-boxes">
              ...
              <div class="text sign-up-text">Voce ainda não tem conta? <label for="flip">Cadastre agora</label></div>
            </div>
          </form>
        </div>
          ...
          <form action="LoginServlet" method="post">
            <div class="input-boxes">
              <div class="input-box">
                ...
                <input type="text" placeholder="Coloque o seu nome" required>
              </div>
              <div class="input-box">
                <i class="fas fa-envelope"></i>
                <input type="text" placeholder="Coloque o seu email" required>
              </div>
              <div class="input-box"> 
                <i class="fas fa-lock"></i>
                <input type="password" placeholder="Coloque a sua senha" required>
              </div>
              <div class="button input-box">
                <input type="submit" value="Cadastrar">
              </div>
              <div class="text sign-up-text">Voce ja tem conta? <label for="flip">Entre agora!</label></div>
            </div>
          </form>
        </div>
      </div>
